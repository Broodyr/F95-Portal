...
- All state services are singletons with injectable storage/clients for tests; 206 tests, `flutter analyze` clean.
...
## Development
- `flutter pub get && flutter run`; `flutter test` (206 tests); `flutter analyze`. Helper scripts in `tool/`.
