  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(ThreadUtils.formatTime(timeUpdated), style: TextStyle(color: Colors.grey[400], fontSize: 12)),
        const SizedBox(width: 16),

        // Likes
        Icon(Icons.favorite, size: 14, color: Colors.grey[400]),
        const SizedBox(width: 4),
        Text(NumberFormatter.formatNumber(likes), style: TextStyle(color: Colors.grey[400], fontSize: 12)),
        const SizedBox(width: 16),
